...
const App = () => {
  ...
  const [votes, setVotes] = useState(new Array(anecdotes.length).fill(0)); // Initialize an array of zeros
  ...
  return (
    <div>
      ...
      <Vote text="Vote" value={votes[selected]} handleClick={handleVote} />
